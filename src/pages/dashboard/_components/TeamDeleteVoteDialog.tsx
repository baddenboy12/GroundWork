        ...
        {vote === undefined ? (
          ...
          <>
            ...
            <div className="flex gap-2 justify-end pt-1">
              ...
              <Button variant="destructive" onClick={handlePropose} className="text-base">
                Start deletion vote
              </Button>
            </div>
          </>
          ...
          <>
              ...
              <div className="space-y-1.5">
                {vote.members.map((m) => (
                  ...
                  >
                    ...
                    >
                      {m.hasVoted ? <Check className="w-3.5 h-3.5" /> : "…"}
                    </div>
                    <span
                      className={cn(
                        "flex-1 text-base",
            ...
            <div className="flex flex-wrap gap-2 justify-end pt-1">
              ...
              {vote.hasVoted && !vote.isProposer && (
                <Button variant="ghost" disabled className="text-base">
                  <Check className="w-4 h-4 mr-1.5 text-muted-foreground" />
                  Vote recorded
                </Button>
              )}
              ...
              {/* Still needs to vote */}
              {!vote.hasVoted && (
                <Button variant="destructive" onClick={handleCastVote} className="text-base">
