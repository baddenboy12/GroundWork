      ...
      <div className="rounded-2xl border border-border bg-card p-6 space-y-4">
        ...
        <ul className="space-y-3 text-lg text-muted-foreground">
          <li className="flex items-start gap-3">
            <Trash2 className="w-5 h-5 mt-0.5 shrink-0 text-destructive" />
...
function AuthenticatedDeletion() {
  ...
  return (
    <div className="space-y-6">
      <a
        href="/dashboard"
        className="inline-flex items-center gap-2 text-xl text-muted-foreground hover:text-foreground transition-colors"
      >
      ...
      <div className="rounded-2xl border border-destructive/30 bg-destructive/5 p-6 space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground">This action is permanent</h2>
        ...
        <ul className="space-y-2 text-lg text-muted-foreground ml-9">
